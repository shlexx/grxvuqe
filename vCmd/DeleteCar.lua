...
function Destroy(ins)
	spawn(function()
		for _,v in pairs(game:GetDescendants()) do
			if v:IsA("RemoveEvent") and v.Name == "DeleteCar" then
				v:FireServer(ins)
			end
		end
	end)
...
exe.MouseButton1Click:Connect(function()
	...
	elseif args[1] == "ragdoll" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				Destroy(v.Character:FindFirstChildOfClass("Humanoid"))
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Name == game.Players.LocalPlayer.Name then else
			...
			Destroy(p.Character:FindFirstChildOfClass("Humanoid"))
		end
	elseif args[1] == "kill" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				Destroy(v.Character.Head)
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Name == game.Players.LocalPlayer.Name then else
			...
			Destroy(p.Character.Head)
		end
	elseif args[1] == "naked" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				Destroy(v.Character:FindFirstChildOfClass("Shirt"))
				Destroy(v.Character:FindFirstChildOfClass("Pants"))
				Destroy(v.Character:FindFirstChildOfClass("ShirtGraphic"))
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Name == game.Players.LocalPlayer.Name then else
			...
			Destroy(p.Character:FindFirstChildOfClass("Shirt"))
			Destroy(p.Character:FindFirstChildOfClass("Pants"))
			Destroy(p.Character:FindFirstChildOfClass("ShirtGraphic"))
		end
	elseif args[1] == "goto" then
		...
		getRoot(Players.LocalPlayer.Character).CFrame = getRoot(Players[p].Character).CFrame + Vector3.new(3,1,0)
	...
	elseif args[1] == "box" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				...
				Destroy(v.Character:FindFirstChildOfClass("Shirt"))
				Destroy(v.Character:FindFirstChildOfClass("ShirtGraphic"))
				Destroy(v.Character["Left Arm"])
				Destroy(v.Character["Left Leg"])
				Destroy(v.Character["Right Arm"])
				Destroy(v.Character["Right Leg"])
				Destroy(v.Character.Head:FindFirstChildOfClass("SpecialMesh"))
				Destroy(v.Character.Head:FindFirstChildOfClass("Decal"))
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Name == game.Players.LocalPlayer.Name then else
			...
			for i, x in pairs(p.Character:GetChildren()) do
				if x:IsA("Accessory") then
					Destroy(x)
				end
			end
			...
			Destroy(p.Character:FindFirstChildOfClass("Shirt"))
			Destroy(p.Character:FindFirstChildOfClass("ShirtGraphic"))
			Destroy(p.Character["Left Arm"])
			Destroy(p.Character["Left Leg"])
			Destroy(p.Character["Right Arm"])
			Destroy(p.Character["Right Leg"])
			Destroy(p.Character.Head:FindFirstChildOfClass("SpecialMesh"))
			Destroy(p.Character.Head:FindFirstChildOfClass("Decal"))
		end
	elseif args[1] == "sink" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				Destroy(v.Character.HumanoidRootPart)
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Name == game.Players.LocalPlayer.Name then else
			...
			Destroy(p.Character.HumanoidRootPart)
		end
...
--]]
	...
	elseif args[1] == "stools" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				Destroy(v.Character:FindFirstChildOfClass("Humanoid"))
				repeat wait() until v.Character:FindFirstChildOfClass("Humanoid").Parent == nil
		...
		elseif args[2] == "others" then
			...
			Destroy(p.Character:FindFirstChildOfClass("Humanoid"))
			repeat wait() until p.Character:FindFirstChildOfClass("Humanoid").Parent == nil
			for _, x in ipairs(p.Character:GetChildren()) do
				if x:IsA("BackpackItem") and x:FindFirstChild("Handle") then
					Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid"):EquipTool(x)
				end
			end
	...
	elseif args[1] == "noregen" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				Destroy(v.Character:FindFirstChild("Health"))
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Name == game.Players.LocalPlayer.Name then else
			...
			Destroy(p.Character:FindFirstChild("Health"))
		end
	elseif args[1] == "stopanim" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				Destroy(v.Character:FindFirstChildOfClass("Humanoid"):FindFirstChildOfClass("Animator"))
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Name == game.Players.LocalPlayer.Name then else
	...
	elseif args[1] == "nolimbs" then
		...
		elseif args[2] == "others" then
			...
			if p.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
				...
				Destroy(p.Character["LeftUpperArm"])
				Destroy(p.Character["LeftUpperLeg"])
				Destroy(p.Character["RightUpperArm"])
				Destroy(p.Character["RightUpperLeg"])
			end
		end
		...
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
					...
					Destroy(v.Character["LeftUpperArm"])
					Destroy(v.Character["LeftLowerArm"])
					Destroy(v.Character["LeftHand"])
				end
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
			...
			if p.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
				...
				Destroy(p.Character["LeftUpperArm"])
				Destroy(p.Character["LeftLowerArm"])
				Destroy(p.Character["LeftHand"])
			end
		end
		...
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
					...
					Destroy(v.Character["LeftUpperLeg"])
					Destroy(v.Character["LeftLowerLeg"])
					Destroy(v.Character["LeftFoot"])
				end
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
			...
			if p.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
				...
				Destroy(p.Character["LeftUpperLeg"])
				Destroy(p.Character["LeftLowerLeg"])
				Destroy(p.Character["LeftFoot"])
			end
		end
		...
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
					...
					Destroy(v.Character["RightUpperArm"])
					Destroy(v.Character["RightLowerArm"])
					Destroy(v.Character["RightHand"])
				end
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
			...
			if p.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
				...
				Destroy(p.Character["RightUpperArm"])
				Destroy(p.Character["RightLowerArm"])
				Destroy(p.Character["RightHand"])
			end
		end
		...
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
					...
					Destroy(v.Character["RightUpperLeg"])
					Destroy(v.Character["RightLowerLeg"])
					Destroy(v.Character["RightFoot"])
				end
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
			...
			if v.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R6 then
				...
				Destroy(p.Character["RightUpperLeg"])
				Destroy(p.Character["RightLowerLeg"])
				Destroy(p.Character["RightFoot"])
			end
		end
	elseif args[1] == "nowaist" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R15 then
					Destroy(v.Character.UpperTorso.Waist)
				end
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
			...
			if p.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R15 then
				Destroy(p.Character.UpperTorso.Waist)
			end
		end
	elseif args[1] == "noroot" then
		if args[2] == "all" then
			for _,v in pairs(game.Players:GetPlayers()) do
				if v.Character:FindFirstChildOfClass("Humanoid").RigType == Enum.HumanoidRigType.R15 then
					Destroy(v.Character.LowerTorso.Root)
				end
			end
		elseif args[2] == "others" then
			for _,v in pairs(game.Players:GetPlayers()) do
