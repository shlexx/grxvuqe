...
local function VCKOX_fake_script() -- Freecam.FreecamScript 
	local scr = Instance.new('LocalScript', Freecam)
	scr.Name = "FreecamScript"
...
coroutine.wrap(VCKOX_fake_script)()
